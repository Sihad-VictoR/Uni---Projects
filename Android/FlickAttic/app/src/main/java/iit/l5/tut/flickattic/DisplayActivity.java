...
public class DisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favBtn = findViewById(R.id.addToFavBtn_DisplayView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        //calling method to add data to list.
        initListViewData();
        //Setting up adapter to recyclerView.
        adapter = new MovieAdapterToDisplayWithCheckBox(DisplayActivity.this,moviesList,true);
        recyclerView.setAdapter(adapter);

        //Updating data to database using a button on click listener.
