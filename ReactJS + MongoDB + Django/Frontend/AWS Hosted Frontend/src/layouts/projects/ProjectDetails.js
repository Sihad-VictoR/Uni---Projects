...
class ProjectDetails extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("http://18.222.231.105/project/get/", config)
      .then((response) => {
  ...
  deleteProject(id) {
    ...
    axios
      .delete("http://18.222.231.105/project/delete/" + id + "/", config)
      .then((response) => {
  ...
  searchProject(searchQuery) {
    ...
    axios
      .get("http://18.222.231.105/project/search/" + searchQuery + "/", config)
      .then((response) => {
        if (response.data != null) {
  ...
  filterProject(filterQuery) {
    ...
    axios
      .get("http://18.222.231.105/project/filter/" + filterQuery + "/", config)
      .then((response) => {
        if (response.data != null) {
          this.setState({ data: response.data });
          console.log(response.data);
  ...
  getProjectToUpdate(id) {
    ...
    axios
      .get("http://18.222.231.105/project/get/" + id + "/", config)
      .then((response) => {
        if (response.data != null) {
