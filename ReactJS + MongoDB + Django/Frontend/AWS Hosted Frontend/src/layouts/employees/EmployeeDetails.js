...
class EmployeeDetails extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get("http://18.222.231.105/employee/get/", config)
      .then((response) => {
  ...
  deleteEmployee(id) {
    ...
    axios
      .delete("http://18.222.231.105/employee/delete/" + id + "/", config)
      .then((response) => {
  ...
  filterEmployee(filterQuery) {
    ...
    axios
      .get("http://18.222.231.105/employee/filter/" + filterQuery + "/", config)
      .then((response) => {
        if (response.data != null) {
  ...
  searchEmployee(searchQuery) {
    ...
    axios
      .get("http://18.222.231.105/employee/search/" + searchQuery + "/", config)
      .then((response) => {
        if (response.data != null) {
          this.setState({ data: response.data });
          console.log(response.data);
  ...
  getEmployeeToUpdate(id) {
    ...
    axios
      .get("http://18.222.231.105/employee/get/" + id + "/", config)
      .then((response) => {
        if (response.data != null) {
